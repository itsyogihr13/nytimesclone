...
const Section_latestNewsCard = ({
  ...
  let imgUrl =
    multimedia == null
      ? "https://static01.nyt.com/images/2021/03/10/us/10oil-01/10oil-01-mediumThreeByTwo210.jpg"
      : multimedia[4].url;
  let caption =
    multimedia == null
  ...
  let largeImg =
    multimedia == null
      ? "https://static01.nyt.com/images/2021/03/11/multimedia/11virus-astrazeneca-denmark1/merlin_182654916_deba33c0-da8b-4e82-b168-aa7681c091d8-superJumbo.jpg"
      : multimedia[0].url;
  const location = useLocation(window.search);
  const history = useNavigate(location);
  const payload = {
    head: title,
    sub: abstract,
    img: largeImg,
