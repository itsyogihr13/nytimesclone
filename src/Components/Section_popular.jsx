          ...
          <Paper className={classes.paper} onClick={handleClick1}>
            ...
            >
              <div>
                ...
                >
                  {Month(date1[1])} {day1[0]}, {date1[0]}
                </div>
              </div>
              <div>
                <img
                  style={{ width: "350px", height: "280px" }}
                  src={data1.multimedia[4].url}
                  alt="small"
                />
              </div>
            </div>
            ...
            >
              ...
              >
                <span style={{ marginRight: "5px" }}>
                  {Month(date2[1])} {day2[0]}, {date2[0]}{" "}
                </span>{" "}
                <span> {data2.byline} </span>{" "}
              </div>
            </div>
          </Paper>
        </Grid>
          ...
          <Paper className={classes.paper} onClick={handleClick3}>
            <div style={{ display: "flex" }}>
              <div>
                ...
                >
                  {Month(date3[1])} {day3[0]}, {date3[0]}
                </div>
              </div>
              <div>
                <img
                  style={{ width: "350px", height: "200px" }}
                  src={data3.multimedia[4].url}
                  alt="small"
                />
              </div>
            </div>
          ...
          <Paper className={classes.paper} onClick={handleClick4}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ display: "flex" }}>
                ...
                <div>
                  {" "}
                  <img src={data4.multimedia[4].url} alt="small" />{" "}
                </div>
              </div>
              <div
                style={{
              ...
              >
                <span style={{ marginRight: "5px" }}>
                  {Month(date4[1])} {day4[0]}, {date4[0]}{" "}
                </span>{" "}
                <span> {data4.byline} </span>{" "}
              </div>
            </div>
          </Paper>
        </Grid>
